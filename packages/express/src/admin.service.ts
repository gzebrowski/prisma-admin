...
export class BaseAdminService {
    ...
    async processFilesData(filesData: Record<string, Express.Multer.File> | null, idItem: string | number | null, model: string): Promise<Record<string, string | null>> {
    ...
    async updateModelItem(req: Request, model: string, idItem: string, itemData: Record<string, any> | null, filesData?: Record<string, Express.Multer.File> | null) {
        if (filesData) {
    ...
    async processInlineFile(fieldName: string, model: string, file: Express.Multer.File, idItem?: string | number | null): Promise<string | null> {
        const fieldAndTypes = await this.adminLogicService.getModelFieldsAndTypes(model);
    ...
    async createModelItem(req: Request, model: string, data: Record<string, any> | null, filesData?: Record<string, Express.Multer.File> | null) {
        if (filesData) {
