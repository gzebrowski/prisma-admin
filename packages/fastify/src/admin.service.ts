...
export class BaseAdminService {
    ...
    async getModelItems(req: FastifyRequest, model: string, page: number, filters: Record<string, any> = {}): Promise<any> {
    ...
    async performAction(req: FastifyRequest, user: any, model: string, action: string, ids: string[]) {
    ...
    async getModelItem(req: FastifyRequest, model: string, idItem: string, params: Record<string, any> = {}): Promise<any> {
    ...
    async updateModelItem(req: FastifyRequest, model: string, idItem: string, itemData: Record<string, any> | null, filesData?: Record<string, MultipartFile> | null) {
        if (filesData) {
        ...
        return await this.adminLogicService.updateModelItem(req, model, idItem, itemData, filesData as any);
    }
    ...
    async createModelItem(req: FastifyRequest, model: string, data: Record<string, any> | null, filesData?: Record<string, MultipartFile> | null) {
        if (filesData) {
        ...
        return await this.adminLogicService.createModelItem(req, model, data, filesData as any);
    }

    async getModelMetadata(req: FastifyRequest, model: string, params: Record<string, any> = {}): Promise<any> {
        return await this.adminLogicService.getModelMetadata(req, model, params);
    }

    async getAutocompleteItems(req: FastifyRequest, model: string, targetModel: string, keyField: string, query: string, depData: Record<string, any>) {
        return await this.adminLogicService.getAutocompleteItems(req, model, targetModel, keyField, query, depData);
    }

    async deleteObject(req: FastifyRequest, model: string, idItem: string) {
        const fieldAndTypes = await this.adminLogicService.getModelFieldsAndTypes(model);
